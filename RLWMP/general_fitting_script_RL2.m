...
% This script performs model fitting. output was saved in /Fits. New output
% will be saved in NewFits.

clear all;

Demo = true;
tic
% in demo mode, fit 1 model, 2 participants with 2 starting points (0.5s)
% in non-demo mode, fit all models, all participants with w0 starting
% points. 35*19*10 times longer. 
